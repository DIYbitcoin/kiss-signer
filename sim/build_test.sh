...
clang -O1 -w \
  ...
  sim/test_crypto.c sim/test_proof.c sim/test_qr.c sim/test_seed.c sim/test_backup.c sim/test_sp.c sim/test_sdseed.c sim/test_duress.c sim/test_passedit.c sim/test_tapent.c sim/test_dice.c sim/test_lastword.c sim/test_cards_q.c sim/test_fw.c sim/test_art.c \
  -lm -o /tmp/kisstest
