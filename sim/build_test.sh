...
clang -O1 -w \
  ...
  main/wallet_crypto.c main/wallet_psbt.c main/wallet_sp.c main/wallet_seed.c main/wallet_seed_sd.c main/platform_sd.c main/wallet_usage.c main/wallet_backup.c main/wallet_duress.c main/qr_transport.c main/wallet_tapent.c main/wallet_dice.c main/wallet_dice_q.c main/wallet_cards_q.c main/wallet_lastword.c main/wallet_proof.c main/verify_page.c \
  sim/test_crypto.c sim/test_proof.c sim/test_qr.c sim/test_seed.c sim/test_backup.c sim/test_sp.c sim/test_sdseed.c sim/test_duress.c sim/test_passedit.c sim/test_tapent.c sim/test_dice.c sim/test_lastword.c sim/test_cards_q.c \
  -lm -o /tmp/kisstest
