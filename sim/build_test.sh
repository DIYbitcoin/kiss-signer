...
clang $KISS_BOARD_CFLAGS ${KISS_WERROR:+-Werror} -O1 -Wall -Wextra -Wno-unused-parameter -Wno-implicit-const-int-float-conversion -Wno-missing-field-initializers -Wno-deprecated-declarations \
  ...
  main/kiss_crypto.c main/kiss_psbt.c main/kiss_sp.c main/kiss_seed.c main/kiss_seed_sd.c main/kiss_kef.c main/kiss_kef_crypto.c main/kiss_pbkdf2.c main/platform_sd.c main/kiss_usage.c main/kiss_payee.c main/kiss_backup.c main/kiss_duress.c main/kiss_gword.c main/kiss_coverword.c main/qr_transport.c main/kiss_tapent.c main/kiss_dice.c main/kiss_dice_q.c main/kiss_rngq.c main/kiss_cards_q.c main/kiss_lastword.c main/kiss_rehearse.c main/kiss_fw.c main/kiss_pqsig.c main/kiss_art_rle.c \
  sim/test_crypto.c sim/test_qr.c sim/test_seed.c sim/test_backup.c sim/test_sp.c sim/test_sdseed.c sim/test_kef.c sim/test_duress.c sim/test_gword.c sim/test_coverword.c sim/test_passedit.c sim/test_tapent.c sim/test_dice.c sim/test_rngq.c sim/test_lastword.c sim/test_rehearse.c sim/test_cards_q.c sim/test_fw.c sim/test_art.c sim/test_pq.c sim/test_usage.c sim/test_defrow.c \
