...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (128 * 1024U)         /**< [bytes] matches device CONFIG_LV_MEM_SIZE_KILOBYTES;
                                               * 64K starved the i18n language picker (failed glyph-buf
                                               * malloc = LVGL assert = infinite loop) */
