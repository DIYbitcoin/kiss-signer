...
clang -O1 -w -DSIMULATOR -DLV_CONF_INCLUDE_SIMPLE -DKISS_VERSION_STR="\"$VER\"" \
  ...
  $SRCS main/main.c main/sprites.c main/menu_img.c main/menu_logo.c main/gameover_img.c main/wallet_img.c main/tile_lbls.c main/wallet_ui.c main/wallet_theme.c main/wallet_info.c main/wallet_recv.c main/wallet_sign.c main/wallet_scan.c main/wallet_settings.c main/wallet_setup.c main/qr_transport.c main/platform_sd.c \
