...
clang -O1 -w -DSIMULATOR -DLV_CONF_INCLUDE_SIMPLE -DLV_LVGL_H_INCLUDE_SIMPLE -DKISS_VERSION_STR="\"$VER\"" \
  -I"$LVGL" -Isim -Imain -Icomponents/cUR/src -Icomponents/bitsquiggle32 \
  $SRCS main/main.c main/sprites.c main/menu_img.c main/menu_logo.c main/gameover_img.c main/game_bg.c main/wallet_img.c main/wallet_ui.c main/wallet_theme.c components/bitsquiggle32/bitsquiggle32.c main/wallet_info.c main/wallet_recv.c main/wallet_sign.c main/wallet_scan.c main/wallet_settings.c main/wallet_setup.c main/wallet_duress.c main/wallet_duress_ui.c main/wallet_usage.c main/wallet_sp.c main/i18n.c main/i18n_tables.c main/font_kiss_*.c main/flag_imgs.c main/qr_transport.c main/platform_sd.c \
