...
[`main/kiss_recv.c:1236`](../main/kiss_recv.c#L1236)
...
[`main/kiss_recv.c:1348`](../main/kiss_recv.c#L1348)
...
[`main/kiss_rngaudit.c:161`](../main/kiss_rngaudit.c#L161)
...
[`main/kiss_settings.c:1951`](../main/kiss_settings.c#L1951)
...
[`main/kiss_settings.c:1988`](../main/kiss_settings.c#L1988)
...
[`main/kiss_settings.c:2196`](../main/kiss_settings.c#L2196)
...
[`main/kiss_settings.c:2325`](../main/kiss_settings.c#L2325)
...
[`main/kiss_settings.c:2559`](../main/kiss_settings.c#L2559)
...
[`main/kiss_settings.c:2599`](../main/kiss_settings.c#L2599)
...
[`main/kiss_settings.c:2638`](../main/kiss_settings.c#L2638)
...
[`main/kiss_setup.c:2451`](../main/kiss_setup.c#L2451)
...
[`main/kiss_setup.c:3512`](../main/kiss_setup.c#L3512)
...
[`main/kiss_setup.c:3725`](../main/kiss_setup.c#L3725)
...
[`main/kiss_sign.c:796`](../main/kiss_sign.c#L796)

### the montserrat48 tick at y=236 and the padlock beside it are GONE, and the tick joins the title

SIGNED was claimed three times on this screen -- the page title, that 48px checkmark, and a note under it -- while the two facts an owner actually leaves with, which file and what to do next, had no room. One claim, once, on the row that already carries the word. ...and then OUTPUTS FIXED went too, which is what took the last parameter off this function. It was a font14 pair riding the title of the one screen whose whole job is to say what to do next, and it answered a question about sighash flags the owner was asked and had already approved two screens back. Both exit screens carry the same head now.

[`main/kiss_sign.c:991`](../main/kiss_sign.c#L991)
...
[`main/kiss_sign.c:1580`](../main/kiss_sign.c#L1580)
...
[`main/kiss_sign.c:1692`](../main/kiss_sign.c#L1692)
...
[`main/kiss_sign.c:1708`](../main/kiss_sign.c#L1708)
...
[`main/kiss_sign.c:2054`](../main/kiss_sign.c#L2054)
...
[`main/kiss_sign.c:2069`](../main/kiss_sign.c#L2069)
...
[`main/kiss_sign.c:2896`](../main/kiss_sign.c#L2896)
...
[`main/kiss_sign.c:3214`](../main/kiss_sign.c#L3214)
...
[`main/kiss_sign.c:3398`](../main/kiss_sign.c#L3398)
...
[`main/kiss_theme.c:4515`](../main/kiss_theme.c#L4515)
...
[`main/kiss_theme.c:4594`](../main/kiss_theme.c#L4594)
...
[`main/kiss_theme.c:5157`](../main/kiss_theme.c#L5157)
...
[`main/kiss_theme.c:7501`](../main/kiss_theme.c#L7501)
...
[`main/kiss_theme.c:7919`](../main/kiss_theme.c#L7919)
...
[`main/main.c:1957`](../main/main.c#L1957)
...
[`sim/sim_main.c:4865`](../sim/sim_main.c#L4865)
