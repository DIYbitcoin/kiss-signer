...
// joins them. See kiss_cards_q.h for what this does and does not promise.
//
...
// length, or 0. Same shape and same reason as wd_period in kiss_dice_q.c —
