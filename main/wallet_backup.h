...
//
// The answer used to be a session flag in wallet_ui.c, cleared on every login
...
// deliver, and wallet_usage.c already writes raw fingerprints into its own NVS
...
// AMNESIC mode never persists, same rule as wallet_usage: a device that gets
