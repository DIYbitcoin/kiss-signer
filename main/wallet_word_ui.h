...
//
// Its own module rather than another act inside wallet_duress_ui.c. That wizard
...
void wallet_word_ui_open(lv_obj_t *parent, void (*done_cb)(void));
...
// wallet_duress_ui_active.
bool wallet_word_ui_active(void);
