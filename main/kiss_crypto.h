...
#ifndef KISS_RELEASE
// Fault injection, non-release only: make kiss_sign_selftest report stage 99
// so the suite can prove kiss_psbt_sign actually refuses. Same reasoning as
...
// only after kiss_seed_commit succeeds.
...
// INTERNAL — signing module (kiss_psbt.c) only. The session's bip32 master,
