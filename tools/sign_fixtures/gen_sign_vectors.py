...
Usage:
  ./venv/bin/python tools/sign_fixtures/gen_sign_vectors.py > sim/sign_vectors.h

Schnorr (silent-payment) vectors are not produced here: reproducing KISS's
aux = sha256(spend_priv || sha256(psbt_bytes)) independently needs the
SP-capable embit fork the sibling gen_spend_vectors.py already depends on. See
docs/specs/verifiable-determinism.md.
"""
...
HEADER = """// GENERATED by tools/sign_fixtures/gen_sign_vectors.py - do not hand-edit.
//
