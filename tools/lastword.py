...
The BLIND DRAW flow asks the owner to draw 11 or 23 words blind from a
physical copy of the BIP39 list, and then picks the final word from the list
this prints. Run it on a computer
