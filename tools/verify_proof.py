#!/usr/bin/env python3
"""Check a KISS Signer proof file on any computer. No dependencies.
...
FRAME_BYTES = 1288 * 728 * 2  # raw RGB565, the whole sensor frame


def main():
    path = sys.argv[1] if len(sys.argv) > 1 else "kiss-proof.bin"
